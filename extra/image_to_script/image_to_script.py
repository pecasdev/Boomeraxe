...
def read_pixel(x,y,pixel):
    ...
    if pixel==(000,000,100):    obj='obj_wall_crumble'
    if pixel==(000,000,200):    obj='obj_platform'
    if pixel==(100,000,000):    obj='obj_spike'
    if pixel==(200,000,000):    obj='obj_spike_retract'
    if pixel==(000,200,000):    obj='obj_savepoint'
    if pixel==(200,200,000):    obj='obj_torch'
    if pixel==(250,000,000):    obj='obj_enemy0'
    if pixel==(250,000,050):    obj='obj_enemy1'
    if pixel==(250,000,100):    obj='obj_enemy2'
    if pixel==(250,000,150):    obj='obj_enemy3'

    if obj!='empty':
        script[x+y*img.size[0]]='instance_create({},{},{})'.format(x*20,y*20,obj)
